...
function PrivacyPolicy(props: Props) {
    ...
    return (
        <div className="privacyPolicy">
            ...
            <h2>Open source</h2>
            <p>This software is completely open source.  All packages used, including this project, are released under the <a target="_blank" href="https://en.wikipedia.org/wiki/MIT_License">MIT license</a>.  Please find <a target="_blank" href={GithubUrl}>the project on github</a> for the source code or to contribute.</p>
            ...
            <p><a target="_blank" href="https://ec.europa.eu/info/live-work-travel-eu/coronavirus-response/safe-covid-19-vaccines-europeans/eu-digital-covid-certificate_en#what-is-the-eu-digital-covid-certificate">Read more</a></p>
            
            <p>The UK National Health Service (NHS) has also adopted the same format for it's COVID Pass.</p>
            <p><a target="_blank" href="https://www.nhs.uk/conditions/coronavirus-covid-19/covid-pass/">Read more</a></p>
            
            <p>The initial EU project, previously called "Digital Green Certificates" is open source and on github.</p>
            <p><a target="_blank" href="https://github.com/eu-digital-green-certificates">View on Github</a></p>
            ...
            <p><a target="_blank" href="https://ec.europa.eu/health/ehealth/covid-19_en">View EU eHealth page</a></p>
